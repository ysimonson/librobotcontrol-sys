...
RUN git clone https://github.com/richfelker/libcompat_time32.git

WORKDIR /app/libcompat_time32
RUN make srcdir=/app/musl

WORKDIR /app
RUN make LDFLAGS="-lm -lrt -pthread -shared -Wl,-soname,librobotcontrol.so.1 -Wl,--whole-archive -L/app/libcompat_time32/libcompat_time32.a -Wl,--no-whole-archive"
RUN make install
...
RUN ldd /app/lib/librobotcontrol.a
